...
export default function RestaurateurOrdersPage() {
    ...
    const handleOrderClick = (orderId: string) => {
        router.push(`/dashboard/restaurateur/achats/orders/${orderId}`);
    };
    ...
    return (
        <ProtectedRoute requiredProfileType="PRO">
            <DashboardLayout businessType="RESTAURATEUR" title="Mes commandes fournisseurs">
                <div className={styles.container}>
                    {/* Header */}
                    <div className={styles.header}>
                        <button onClick={() => router.push('/dashboard/restaurateur/achats')} className={styles.backButton}>
                    ...
                    {loading && page === 1 ? (
                        ...
                        <div className={styles.empty}>
                            ...
                            <button
                                ...
                                onClick={() => router.push('/dashboard/restaurateur/achats')}
                            >
