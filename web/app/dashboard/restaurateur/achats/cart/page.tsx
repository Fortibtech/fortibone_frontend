...
export default function CartPage() {
    ...
    const handleCheckout = async () => {
        ...
        try {
            ...
            router.push('/dashboard/restaurateur/achats/orders');
        } catch (err: any) {
    ...
    if (items.length === 0) {
        return (
            <ProtectedRoute requiredProfileType="PRO">
                <DashboardLayout businessType="RESTAURATEUR" title="Mon Panier">
                    <div className={styles.emptyContainer}>
                        ...
                        <Link href="/dashboard/restaurateur/achats" className={styles.continueBtn}>
            ...
            <DashboardLayout businessType="RESTAURATEUR" title="Mon Panier">
                <div className={styles.container}>
                    ...
                    <div className={styles.header}>
                        <Link href="/dashboard/restaurateur/achats" className={styles.backButton}>
                            {icons.back}
                        </Link>
