...
export default function SettingsPage() {
    ...
    useEffect(() => {
        if (selectedBusiness) {
            ...
            // Ces propriétés peuvent ne pas exister sur tous les types de business
            ...
            <DashboardLayout businessType={dashboardType.toUpperCase() as any}>
                <div className={styles.container}>
                    <div className={styles.loadingContainer}>
                        <p>Sélectionnez une entreprise pour accéder aux paramètres</p>
                    </div>
                </div>
            </DashboardLayout>
        );
        ...
        <DashboardLayout businessType={dashboardType.toUpperCase() as any}>
            <div className={styles.container}>
                ...
                <div className={styles.section}>
                    ...
                    <div className={styles.avatarSection}>
                        <div className={styles.avatar}>
                            {selectedBusiness.name?.charAt(0) || 'E'}
                        </div>
                        <div className={styles.avatarInfo}>
                            <h3>{selectedBusiness.name}</h3>
                            <p>{(selectedBusiness as any).commerceType || selectedBusiness.type || 'Entreprise'}</p>
                ...
                <div className={`${styles.section} ${styles.dangerSection}`}>
                    <h2 className={styles.sectionTitle}>
                        <span className={styles.sectionIcon} style={{ background: '#ef4444' }}>{icons.danger}</span>
                        Zone de danger
                    </h2>

                    <div className={styles.toggleRow}>
                        <div className={styles.toggleInfo}>
                            <div className={styles.toggleLabel}>Désactiver l&apos;entreprise</div>
                            <div className={styles.toggleDescription}>
                                Mettre l&apos;entreprise hors ligne temporairement
                            </div>
                        </div>
                        <button className={styles.dangerButton}>Désactiver</button>
                    </div>
                </div>
