...
export default function ProductDetailPage() {
    ...
    if (loading || !product) {
        return (
            <ProtectedRoute requiredProfileType="PRO">
                <DashboardLayout businessType="COMMERCANT" title="Détails produit">
    ...
    return (
        <ProtectedRoute requiredProfileType="PRO">
            <DashboardLayout businessType="COMMERCANT" title={product.name}>
                <div className={styles.container}>
                    ...
                    <div className={styles.header}>
                        ...
                        <Link href="/dashboard/commercant/achats/cart" className={styles.cartLink}>
                            {icons.cart}
