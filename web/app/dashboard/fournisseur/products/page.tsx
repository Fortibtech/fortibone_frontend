...
import styles from '../../commercant/products/products.module.css';
...
export default function FournisseurProductsPage() {
    ...
    const exportToPDF = () => {
        ...
        const htmlContent = `
            ...
            <h1>Inventaire B2B - ${new Date().toLocaleDateString('fr-FR')}</h1>
            <table><thead><tr>
    ...
    return (
        <ProtectedRoute requiredProfileType="PRO">
            <DashboardLayout businessType="FOURNISSEUR" title="Produits B2B">
                    ...
                    {activeTab === 'catalogue' ? (
                        <>
                            ...
                            <div className={styles.header}>
                                ...
                                <Link href="/dashboard/fournisseur/products/add" className={styles.addBtn}>
                            ...
                            <div className={styles.productsGrid}>
                                {loading ? (
                                            ...
                                            <div className={styles.productInfo}>
                                                ...
                                                <div className={styles.productFooter}>
                                                    ...
                                                    <div className={styles.actions}>
                                                        <Link
                                                            href={`/dashboard/fournisseur/products/${product.id}`}
                                    ...
                                    <div className={styles.emptyState}>
                                        <p>Aucun produit dans votre catalogue B2B</p>
                                        <Link href="/dashboard/fournisseur/products/add" className={styles.addBtn}>
                        ...
                        <div className={styles.inventoryContainer}>
                            ...
                            <div className={styles.inventoryHeader}>
                                <div className={styles.inventoryHeaderLeft}>
                                    <h1>📦 Inventaire B2B</h1>
                                    <p className={styles.subtitle}>Gérez vos stocks de gros</p>
                                </div>
                                <div className={styles.inventoryHeaderRight}>
                                    <button
                                        ...
                                        style={{
                                            color: expiringCount > 0 ? '#DC2626' : '#6366F1',
                                            borderColor: expiringCount > 0 ? '#DC2626' : '#6366F1'
                                        }}
                                    >
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                            ...
                                            filteredInventory.map((item) => (
                                                <div key={item.id} className={styles.tableRow}>
                                                    ...
                                                    <span className={styles.colActions}>
                                                        <Link
                                                            href={`/dashboard/fournisseur/products/inventory/${item.id}`}
