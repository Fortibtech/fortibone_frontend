...
// Wallet import removed as it is not used on Home
...
export default function ParticulierDashboard() {
    ...
    // Initial load: Products (Wallet removed)
    useEffect(() => {
        // Geolocation
        ...
        <ProtectedRoute requiredProfileType="PARTICULIER">
            ...
            >
                ...
                <div className={styles.content}>
                    ...
                    {/* === QUICK CATEGORIES & WALLET REMOVED FOR MOBILE PARITY === */}
                    {/* The Mobile Home screen is purely a feed. Quick Actions and Balance are not present. */}
