...
// Aligné avec mobile (api/validation.ts)
// Module de validation pour les entreprises
...
export class BusinessValidation {
    ...
    static validateImageFile(file: File | null, type: 'logo' | 'cover'): ValidationResult {
        const errors: ValidationError[] = [];
    ...
    static canDeleteBusiness(currentUserRole: string): ValidationResult {
        const errors: ValidationError[] = [];
