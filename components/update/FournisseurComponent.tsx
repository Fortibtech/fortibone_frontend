...
const EditBusinessFournisseur: React.FC<Props> = ({ id }) => {
  ...
  const loadData = async () => {
    try {
      ...
      // Chargement des secteurs FOURNISSEUR
  ...
  const loadSectors = async (currentSectorId?: string) => {
    try {
      ...
      const fetched = await getAllSectores("FOURNISSEUR");
      setSectors(fetched);
          ...
          <View style={styles.content}>
            ...
            <View style={styles.formGroup}>
              ...
              >
                ...
                >
                  {selectedSector?.name || "Sélectionnez"}
                </Text>
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                placeholder="Présentez votre activité, vos produits..."
              />
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                onChangeText={setDeliveryZonesText}
                  ...
                  onChangeText={async (text) => {
                    ...
                    try {
                      const res = await fetch(
                        ...
                        { headers: { "User-Agent": "FortibOne-App/1.0" } }
                      );
