...
let ApplicationsService = class ApplicationsService {
    ...
    findAll() {
        return this.prisma.application.findMany({ include: { job: true, candidate: true } });
    }
    findOne(id) {
        return this.prisma.application.findUnique({ where: { id }, include: { job: true, candidate: true } });
    }
