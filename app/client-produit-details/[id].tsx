...
const ProductDetails = () => {
  ...
  const inCart = product && currentVariant ? isInCart(product.id, currentVariant.id) : false;
    ...
    <SafeAreaView style={styles.container}>
          ...
          <View style={{ flexDirection: "row", gap: 10 }}>
            ...
            >
              <Image
                ...
                style={[styles.icon, isFavorite ? { tintColor: "#fff" } : { tintColor: "#000" }]}
              />
            </TouchableOpacity>
          </View>
        </View>
      ...
      <View style={styles.fixedInfo}>
        ...
        {outOfStock ? (
          ...
          <Text style={styles.inStock}>{currentVariant?.quantityInStock} en stock</Text>
        )}
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <ProductOptionsSelector product={product} onVariantSelect={setSelectedVariant} />
        </View>
