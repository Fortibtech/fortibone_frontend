  ...
  const renderItem = ({ item }: { item: Business }) => (
    <TouchableOpacity
      ...
      onPress={async () => {
        ...
        // 👉 on redirige vers un écran TransactionsDetails pour ce business
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.header}>
        <Ionicons name="card-outline" size={32} color="#2c3e50" />
        <Text style={styles.headerTitle}>Transactions des entreprises</Text>
        <Text style={styles.headerDescription}>
          Consultez l’historique des transactions de paiement par entreprise.
        </Text>
      </View>
